...
public partial class Form1 : Form {
  ...
  Song[] playlist;
  Song[] songs = {
    new Song(Path.Combine(Application.StartupPath, "Resources\\1.wav"), "Style",
             "Taylor Swift"),
    new Song(Path.Combine(Application.StartupPath, "Resources\\2.wav"),
             "Anti-hero", "Taylor Swift"),
    new Song(Path.Combine(Application.StartupPath, "Resources\\3.wav"),
             "Just the Way You Are", "Bruno Mars"),
    new Song(Path.Combine(Application.StartupPath, "Resources\\4.wav"),
             "Rain On Me", "Lady Gaga ft. Ariana Grande"),
    new Song(Path.Combine(Application.StartupPath, "Resources\\5.wav"),
             "I Want To Break Free", "Queen"),
    new Song(Path.Combine(Application.StartupPath, "Resources\\6.wav"),
  ...
  private void button1_Click(object sender, EventArgs e) {
    ...
    if (comboBox1.SelectedItem == null) {
      MessageBox.Show("Board size selection box has an invalid parameter!",
  ...
  private void playerTwoScore_Paint(object sender, PaintEventArgs e) {
    ...
    e.Graphics.FillEllipse(new SolidBrush(spelbord1.PlayerTwoColor), 0, 0,
                           box.Width, box.Height);
  }

  private void playerOneScore_Paint(object sender, PaintEventArgs e) {
    PictureBox box = (PictureBox)sender;
    e.Graphics.FillEllipse(new SolidBrush(spelbord1.PlayerOneColor), 0, 0,
                           box.Width, box.Height);
  }
  ...
  private void Form1_Load(object sender, EventArgs e) {
    ...
    playingSongLabel.Text =
        $"Now playing: {playlist[songIndex].GetTitle()} by {playlist[songIndex].GetAuthor()}";
    outputDevice.Play();
  }
